...
import CompetitionTabs from "@/components/competition/competiton-tabs";
...
export default function CompetitionMainPage() {
    ...
    return (
        <div className="w-[70%] min-w-[1200px] mx-auto py-6 space-y-10">
            ...
            <CompetitionTabs userId={userId} key={refresh ? "1" : "0"}/>
                ...
                <div className="space-y-4">
                    <div className="flex gap-2">
                        <Button variant={tab === "joined" ? "default" : "outline"}
                                onClick={() => setTab("joined")}>History</Button>
                        <Button variant={tab === "held" ? "default" : "outline"}
                                onClick={() => setTab("held")}>My Events</Button>
                    </div>
